...
node["apache"]["sites"].each do |sitename, data|
	...
	# It will populate our template located in /root/chef-repo/cookbooks/apache/templates/vhost.erb
	# It will get populated with the content, which we specified, in below template :document_root, :port and :domain
